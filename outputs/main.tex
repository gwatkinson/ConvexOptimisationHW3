...
and \(\lambda \ge 0\) is a regularization parameter.
...
\tag{LASSO'}
\begin{array}{ll}
\min & \frac{1}{2} \left\lVert z \right\rVert^2_2 + \lambda \left\lVert w \right\rVert_1 \\
...
\text{subject to} & - X^T v \le \lambda \cdot \mathbb{1} \\
& X^T v \le \lambda \cdot \mathbb{1}
\end{array}
\end{equation}
